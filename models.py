...
class LR(Model):
    def __init__(self, input_dim=None, output_dim=1, init_path=None, opt_algo='gd', learning_rate=1e-2, l2_weight=0, random_seed=None):
        Model.__init__(self)
        ...
        with self.graph.as_default():
            if random_seed is not None:
                # set_random_seed -> 初期化图级和操作级的参数
                #                 -> グラフレベルとオペレーションレベルのパラメータを初期化する
